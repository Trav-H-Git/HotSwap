...
:: Runtime Build
:: cl.exe /LD /MDd /EHsc /std:c++20 /D"XEN_WINDOWS" /I"C:\Engines\HotSwap" "..\..\scripts\script.cpp" /Yu"build\bin\xen_core.h" /Fp"xen_core.pch" /Fe"scripts.dll" /link /LIBPATH:"build\bin" xen_core.lib "obj\xen_core.obj"
cl.exe /LD /MDd /EHsc /std:c++20 /D"XEN_WINDOWS" "script.cpp" /Yu"xen_core.h" /Fp"xen_core.pch" /Fe"scripts.dll" /showIncludes /link /LIBPATH:"." xen_core.lib "obj\xen_core.obj"
